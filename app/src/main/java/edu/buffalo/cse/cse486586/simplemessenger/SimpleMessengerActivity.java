...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
             * I went through the Oracle Socket Tutorial to understand how simple message can be
             * passed between Server and Client. URL: https://docs.oracle.com/javase/tutorial/networking/sockets/index.html.
             * The "KnockKnock" here shows how Server and Client send msg back and forth to each other.
             * StackOverflow had a simple example on how this to and fro communication happens.
             * URL: https://stackoverflow.com/questions/33978120/client-not-reading-data-from-socket.
             * I did not use the exact code from StackOverflow but the logic used here helped.
             */

           Socket socket = null;
            do {
                try {
                    socket = serverSocket.accept(); //socket is created when Client tries to communicate.
                ...
                /*
                 * without this while loop the two way communication happened only once between
                 * client and server. This while loop helps to keep listening to the client.
                 */
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*
                 * Here the client waits for an ack from Server only then closes the Client socket.
                 */
                PrintWriter out = new PrintWriter(socket.getOutputStream());
                BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()));
                out.write(msgToSend);
                out.flush();
                Log.i(TAG,"Server sent " + in.readLine()); //get ack from Server.
                in.close();
                out.close();
                socket.close();
